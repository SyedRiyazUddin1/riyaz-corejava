...
import java.util.Scanner; //can take input from user via Scanner class

class Account { // this class represents as shared resource
...
class Customer implements Runnable {
	...
	public void run() {
		...
		// syntax of synchronized method below
